 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 96.23 }  // T8, 2 start
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 96.23 }   // T8, 4 start
...
#define X_BED_SIZE 200 - 10
#define Y_BED_SIZE 200 - 10
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE + X_PROBE_OFFSET_FROM_EXTRUDER) / 2) // X point for Z homing when homing all axes (G28).
